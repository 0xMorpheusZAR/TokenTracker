...
import { ArrowLeft, Video, Database, Cpu, Shield, Users, TrendingUp, Globe, Zap, Award, CheckCircle2, ExternalLink, Home, Coins, Building, CreditCard, DollarSign, Trophy, Rocket } from "lucide-react";
...
export default function InterestingProjects() {
  ...
  const [selectedProject, setSelectedProject] = useState<'raiinmaker' | 'estatex' | 'blofin'>('raiinmaker');
  ...
  const projects = {
    ...
    blofin: {
      name: "BloFin x Miles Deutscher",
      subtitle: "Space Trading Competition",
      description: "Join the ultimate trading competition with a $10,000 prize pool",
      icon: Trophy,
      color: {
        primary: "orange",
      ...
      metrics: [
        ...
        { label: "Competition", value: "Live Now" },
        { label: "Trading Platform", value: "BloFin" },
        { label: "Host", value: "Miles Deutscher" }
      ],
      tge: "Competition Ends: TBA",
      links: [
        { label: "Sign Up Now", url: "https://tinyurl.com/MilesDeutscherBlofin10kComp", icon: Rocket },
        { label: "@BloFin_Official", url: "https://x.com/BloFin_Official", icon: Users }
      ]
    }
  };
  ...
  // Content for BloFin Competition
  const blofinContent = {
    overview: (
      <div className="space-y-8 animate-fade-in">
        {/* Competition Banner */}
  ...
  const content = selectedProject === 'raiinmaker' ? raiinmakerContent : selectedProject === 'estatex' ? estatexContent : blofinContent;
          ...
          <div className="container mx-auto px-4 py-12 lg:py-16">
            <div className="text-center space-y-6 relative">
              ...
              <div className="flex justify-center mb-8">
                <Select value={selectedProject} onValueChange={(value: 'raiinmaker' | 'estatex' | 'blofin') => setSelectedProject(value)}>
                  ...
                  <SelectContent className="bg-slate-900 border-slate-700">
                    ...
                    <SelectItem value="blofin" className="text-orange-400 hover:bg-orange-900/20">
                      <div className="flex items-center gap-2">
                        <Trophy className="w-4 h-4" />
                        <span>BloFin Competition</span>
                      </div>
                    </SelectItem>
                  </SelectContent>
                </Select>
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-slate-900/90 backdrop-blur-sm rounded-xl p-1 flex gap-1">
            {(['overview', 'technology', 'tokenomics'] as const).map((tab) => {
              const getTabLabel = () => {
                if (selectedProject === 'blofin') {
                  if (tab === 'overview') return 'Overview';
                  if (tab === 'technology') return 'About';
                  if (tab === 'tokenomics') return 'Rules';
                }
